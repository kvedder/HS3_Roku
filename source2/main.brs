Function Main() as void
    ...
    screen.list = CreateObject("roList")
    screen.list.AddTail("a")
    screen.list.AddTail("b")
    screen.list.AddTail("c")
    screen.list.AddTail("d") 
    screen.list.ResetIndex()
    x= screen.list.GetIndex()
    while x <> invalid
        print x
        x = screen.list.GetIndex()
    end while 
...
Function LoadJSONFile() as void
    ...
    searchRequest.SetURL("http://hs3.tv/api/list_schools.php")
